...
/**
 * Пользовательская реализация изменяемого списка. Этот класс реализует интерфейс {@link
 * IntensiveList} и предоставляет базовые операции, такие как добавление, удаление и получение
